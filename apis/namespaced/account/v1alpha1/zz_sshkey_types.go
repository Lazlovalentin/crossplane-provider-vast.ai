...
type SSHKeyInitParameters struct {
	...
	// rsa AAAA...'). Sensitive value.
	// SSH public key content (e.g., 'ssh-rsa AAAA...'). Sensitive value.
	SSHKeySecretRef v1.LocalSecretKeySelector `json:"sshKeySecretRef" tf:"-"`
}

type SSHKeyObservation struct {

	// (String) Timestamp when the SSH key was created.
	// Timestamp when the SSH key was created.
	CreatedAt *string `json:"createdAt,omitempty" tf:"created_at,omitempty"`

	// (String) Unique numeric identifier of the SSH key.
...
// SSHKey is the Schema for the SSHKeys API. Manages a Vast.ai SSH key.
