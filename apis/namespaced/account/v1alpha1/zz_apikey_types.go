...
type APIKeyInitParameters struct {
	...
	// (String) Name of the API key. Changing this forces a new resource.
	// Name of the API key. Changing this forces a new resource.
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// (String) JSON string of permission configuration. Changing this forces a new resource.
	// JSON string of permission configuration. Changing this forces a new resource.
	Permissions *string `json:"permissions,omitempty" tf:"permissions,omitempty"`
}

type APIKeyObservation struct {

	// (String) Timestamp when the API key was created.
	// Timestamp when the API key was created.
	CreatedAt *string `json:"createdAt,omitempty" tf:"created_at,omitempty"`

	// (String) Unique numeric identifier of the API key.
...
// APIKey is the Schema for the APIKeys API. Manages a Vast.ai API key.
