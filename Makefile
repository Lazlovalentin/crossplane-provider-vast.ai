...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/realnedsanders/terraform-provider-vastai
export TERRAFORM_PROVIDER_VERSION ?= 0.3.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-vastai
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/realnedsanders/terraform-provider-vastai/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
...
xpkg.build.provider-vastai: do.build.images
